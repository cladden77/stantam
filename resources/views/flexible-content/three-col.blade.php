        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="card mx-2">
                <div class="card-body text-center">
                    ...
                    <div class="card-footer"><a class="button button--primary" href="@sub('three_col_left_card_cta', 'url')">@sub('three_col_left_card_cta', 'title')</a>
                    </div>
                </div>
            </div>
            <div class="card mx-2">
                <div class="card-body text-center">
                    ...
                    <div class="card-footer"><a class="button button--primary" href="@sub('three_col_middle_card_cta', 'url')">@sub('three_col_middle_card_cta', 'title')</a>
                    </div>
                </div>
            </div>
            <div class="card mx-2">
                <div class="card-body text-center">
                    ...
                    <div class="card-footer"><a class="button button--primary" href="@sub('three_col_right_card_cta', 'url')">@sub('three_col_right_card_cta', 'title')</a>
                    </div>
                </div>
            </div>
         </div>
